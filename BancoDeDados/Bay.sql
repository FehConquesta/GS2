...
MAXVALUE 1000
NOCYCLE;
CREATE SEQUENCE SEQ_CREDENCIAIS
START WITH 1
INCREMENT BY 1  
MINVALUE 1 
MAXVALUE 1000
...
DROP TABLE T_BC_MONITORAMENTO;



--Criacao de Tabelas
CREATE TABLE T_BC_PLANO_SAUDE(
id_plano NUMERIC CONSTRAINT PK_T_BC_PLANO_SAUDE PRIMARY KEY,
...
CREATE TABLE T_BC_MONITORAMENTO(
id_monitoramento NUMERIC CONSTRAINT PK_T_BC_DADOS_VITAIS PRIMARY KEY,
...
telefone VARCHAR(20) NOT NULL,
id_plano NUMERIC NOT NULL,
id_contato NUMERIC NOT NULL,
id_credencial NUMERIC NOT NULL,
CONSTRAINT FK_T_BC_PACIENTE_T_BC_PLANO_SAUDE FOREIGN KEY(id_plano) REFERENCES T_BC_PLANO_SAUDE(id_plano),
CONSTRAINT FK_T_BC_PACIENTE_T_BC_CONTATO FOREIGN KEY(id_contato) REFERENCES T_BC_CONTATO(id_contato),
CONSTRAINT FK_T_BC_PACIENTE_T_BC_CREDENCIAL FOREIGN KEY(id_credencial) REFERENCES T_BC_MONITORAMENTO(id_monitoramento)
);
...
id_credencial NUMERIC NOT NULL,
id_monitoramento NUMERIC NOT NULL,
CONSTRAINT FK_T_BC_PROFISSIONAL_T_BC_CREDENCIAL FOREIGN KEY(id_credencial) REFERENCES T_BC_CREDENCIAL(id_credencial),
CONSTRAINT FK_T_BC_PROFISSIONAL_T_BC_MONITORAMENTO FOREIGN KEY(id_monitoramento) REFERENCES T_BC_CREDENCIAL(id_credencial)
);